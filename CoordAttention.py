...
class rcan(nn.Module):
    def __init__(self, in_ch, conv=common.default_conv):
        ...
        modules_head = [conv(n_feats, n_feats, kernel_size)]
        ...
        self.body = nn.Sequential(*modules_body)
        #self.csam = CSAM_Module(in_dim=32)
